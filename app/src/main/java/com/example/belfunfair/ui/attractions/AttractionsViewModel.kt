...
class AttractionsViewModel : ViewModel() {
    ...
    companion object {
        ...
        val maneges: Array<Manege> = arrayOf(
            Manege(1,"Autos-tamponeuses","Grand Public",120,description,1,"2023-06-10","2023-06-25"),
            Manege(2,"Bras-mécanique","Sensations",150,description,2,"2023-07-01","2023-07-15"),
            Manege(3,"Tasses","Grand Public",null,description,3,"2023-06-20","2023-07-10"),
            Manege(4,"Chenille","Grand Public",120,description,4,"2023-06-15","2023-06-25"),
            Manege(5,"Carrousel","Grand Public",null,description,5,"2023-07-20","2023-07-30"),
            Manege(6,"Pieuvre","Grand Public",120,description,6,"2023-06-12","2023-06-23"),
            Manege(7,"Chaises-volantes","Sensations",130,description,7,"2023-07-20","2023-08-01")
        )
        val stands: Array<Stand> = arrayOf(
            Stand(1,"Vapiano","Restaurant",description,1,"2023-06-10","2023-06-25"),
            Stand(2,"Ritz","Snack",description,2,"2023-07-01","2023-07-15"),
        )
